...
ak = Weapon.create!(
    name: 'AK-47', base_damage_head: 56, base_damage_chest: 42, base_damage_stomach: 35, 
...
an = Weapon.create!(
    name: 'AN-94', base_damage_head: 46, base_damage_chest: 34, base_damage_stomach: 31, 
...
kilo = Weapon.create!(
    name: 'Kilo 141', base_damage_head: 42, base_damage_chest: 28, base_damage_stomach: 28,
...
fal = Weapon.create!(
    name: 'FAL', base_damage_head: 100, base_damage_chest: 58, base_damage_stomach: 49, 
...
famas = Weapon.create!(
    name: 'FR Famas 5.56', base_damage_head: 64, base_damage_chest: 40, base_damage_stomach: 40, 
...
m13 = Weapon.create!(
    name: 'M13', base_damage_head: 36, base_damage_chest: 24, base_damage_stomach: 24, 
...
scar = Weapon.create!(
    name: 'FN Scar', base_damage_head: 56, base_damage_chest: 35, base_damage_stomach: 35, 
...
ram = Weapon.create!(
    name: 'Ram-7', base_damage_head: 42, base_damage_chest: 28, base_damage_stomach: 28, 
...
grau = Weapon.create!(
    name: 'Grau 5.56', base_damage_head: 42, base_damage_chest: 28, base_damage_stomach: 28, 
    base_damage_limbs: 28, hits_needed_head: '3-6', hits_needed_chest: '4-9', hits_needed_stomach: '4-9',
...
cr = Weapon.create!(
    name: 'CR-56 AMAX', base_damage_head: 56, base_damage_chest: 42, base_damage_stomach: 35, 
    base_damage_limbs: 35, hits_needed_head: '2-5', hits_needed_chest: '3-6', hits_needed_stomach: '3-8',
